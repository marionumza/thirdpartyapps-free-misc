...
var ThemeConfigDialog = Dialog.extend({
    ...
    init: function (parent, options) {
        ...
        this.allWidgets = [];
        return this._super(parent, _.extend(options || {}, {title: options.title,size: options.size || 'extra-large',technical: false,dialogClass: 'd-snippet-config-dialog p-0'}));
    },
    ...
    _tabInfo: function () {
        return [{
            ...
            widgets: [
                ...
                { options: { title: _t('B2b Configuration'), subtitle: _t('Tweak your shop behavior.'), _classes: 'mt-4' }, widgetRef: ThemeOptionTitle },
                { options: { key: 'json_b2b_shop_config', widgets: [{ options: { key: 'dr_enable_b2b', label: _t('Hide Price and disable Add to cart.'), tooltip: _("This option will hide product price for public users and don't allow them to place an order") }, widgetRef: ThemeOptionCheckbox }, { options: { key: 'dr_only_assigned_pricelist', label: _t('Pricelist per customer'), tooltip: _("After enabling this option user will only see assigned pricelist to their contact record.") }, widgetRef: ThemeOptionCheckbox }, { options: { key: 'dr_allow_reorder', label: _t('Enable reorder')}, widgetRef: ThemeOptionCheckbox }]}, widgetRef: ThemeOptionJson},
            ]
        }, {
            name: 'ShopConfig',
            ...
            widgets: [
                ...
                { options: { key: 'json_grid_product', widgets: [
                    ...
                    { options: { key: 'show_stock_label', label: _t('Show stock label')}, widgetRef: ThemeOptionCheckbox },
                ]}, widgetRef: ThemeOptionJson},
                ...
                { options: { key: 'json_shop_filters', widgets: [
                    ...
                    { options: { key: 'show_availability_filter', label: _t('Show availability filter'), tooltip: _("If you have more products this option may affect performance.")}, widgetRef: ThemeOptionCheckbox },
            ...
            widgets: [
                ...
                { options: { title: _t('General'), _classes: 'mt-4' }, widgetRef: ThemeOptionTitle },
                { options: { key: 'bool_show_products_nav', 'label': _t('Product Navigation'), tooltip: _t("Shows button to see next, previous products based on product sequence.") }, widgetRef: ThemeOptionCheckbox},
            ]
        }, {
            name: 'MobileConfig',
            icon: 'fa fa-mobile',
