...
const CartSidebar = Sidebar.extend(VariantMixin, {
    ...
    async _onChangeQty (ev) {
        ...
        let params = {product_id: $target.data('productId'),line_id: $target.data('lineId'),set_qty: quantity};
        this._initiateCartUpdate({ route:'/shop/cart/update_json', params: params});
    },
    _onClearCart: function () {
        this._initiateCartUpdate({ route: '/tp_clear_cart' });
    },
    _initiateCartUpdate: function (data) {
