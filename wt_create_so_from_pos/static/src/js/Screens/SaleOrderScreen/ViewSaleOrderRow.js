odoo.define('wt_create_so_from_pos.ViewSaleOrderRow', function (require) {
    'use strict';
     ...
     * @emits click-order
     */
    class ViewSaleOrderRow extends PosComponent {
        get order() {
    ...
    ViewSaleOrderRow.template = 'ViewSaleOrderRow';

    Registries.Component.add(ViewSaleOrderRow);

    return ViewSaleOrderRow;
});
